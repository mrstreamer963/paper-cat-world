...
export function createFixtureWorld() {
  let world = createWorld({ table: { width: 1400, height: 900 } });
  ...
  add({ id: "note-yellow", kind: "paper", label: "Жёлтая записка", color: 0xf3cc62, width: 210, height: 135, surfaceId: "table", transform: t(610, 520, -.09), zIndex: 4 }, [{ id: "note-yellow-surface", kind: "generic", hostEntityId: "note-yellow", transform: t(0, 0), placementArea: area(210, 135), localVisibility: "visible" }]);
  add({ id: "ticket", kind: "paper", label: "Билет", color: 0x9bb6e5, width: 150, height: 82, surfaceId: "folder-inside", transform: t(70, 55, .06), zIndex: 1 });
  return world;
}
